  ...
  return (
    <Box {...other}>
      ...
      >
        ...
        <ListItemText primary="View Latters" />
      ...
      >
        ...
        <ListItemText primary="Generate Latters" />
        {2 === selectedMenu ? <ExpandLess /> : <ExpandMore />}
      </ListItemButton>
      <Collapse in={2 === selectedMenu} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <NextLink href="/admin/lettergereration/letter?type=probation ">
            <ListItemButton sx={{ pl: 4 }}>
              <ListItemIcon></ListItemIcon>
              <ListItemText primary="Probation Letter" />
            </ListItemButton>
          </NextLink>
          <NextLink href="/admin/lettergereration/letter?type=offer">
            <ListItemButton sx={{ pl: 4 }}>
              <ListItemIcon></ListItemIcon>
